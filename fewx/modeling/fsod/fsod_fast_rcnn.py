...
class FsodFastRCNNOutputLayers(nn.Module):
    ...
    def forward(self, x_query, x_support):
        ...
        if self.patch_relation:
            ...
            k_matrix = self.rcnn_adapt_k_layer(support)  # [128, 49, 64]  k
        ...
        cls_score_all =    cls_score_cor/0.1 + cls_score_fc + cls_score_pr # #+ cls_score_pr)/0.2 
        # cls_score_all =  (cls_score_cor + cls_score_fc + cls_score_pr)/0.2 
        bbox_pred_all =    bbox_pred_cor/0.1 #+ bbox_pred_a # [128, 2048]       
